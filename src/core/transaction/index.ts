...
const getTxInAmount = (txIn: TxIn, aUnspentTxOuts: Array<UnspentTxOut>): number => {
...
const findUnspentTxOut = (
  ...
  index: number,
  aUnspentTxOuts: Array<UnspentTxOut>,
...
const toHexString = (byteArray: Iterable<any> | ArrayLike<any>): string => {
